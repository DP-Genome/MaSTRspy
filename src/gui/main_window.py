...
class MainWindow(QMainWindow):
    ...
    def _prepare_workflow_params(self):
        self.workflow_params = {
            ...
            "str_fasta": self.analysis_page.get_str_fasta(),
            "str_bed": self.analysis_page.get_str_bed(),
            "region_bed": self.analysis_page.get_region_bed(),
            "database_name": self.analysis_page.get_database_name(),
            "needs_prepping": (
...
"""
        ...
        db_name = p.get("database_name", "Unknown")
        review_text += f"""
<h3>Analysis</h3>
...
"""
    ...
    def _reset_workflow(self):
        ...
        self.file_selection_page.detection_label.setText(
