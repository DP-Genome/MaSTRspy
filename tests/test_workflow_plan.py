...
class TestBuildWorkflowPlan:
    ...
    def test_pod5_has_four_steps(self):
        ...
        assert len(plan) == 4
        assert plan.step_names == [
            "basecalling", "demultiplexing", "prepping", "analysis"
        ]
    ...
    def test_analysis_step_always_present(self):
        for ft in [FileType.POD5, FileType.BAM_ALIGNED, FileType.BAM_UNALIGNED,
                    FileType.FASTQ, FileType.UNKNOWN]:
